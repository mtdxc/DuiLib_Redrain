...
LRESULT WindowImplBase::OnCreate(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
	...
	auto callback = Bind(&WindowImplBase::CreateControl, this, std::placeholders::_1);
	...
	if (pControl) {
		...
		ASSERT(pCloseBtn);
		pCloseBtn->AttachClick(Bind(&WindowImplBase::OnButtonClick, this, std::placeholders::_1));
	}
	...
	if (pControl)	{
		...
		ASSERT(pMinBtn);
		pMinBtn->AttachClick(Bind(&WindowImplBase::OnButtonClick, this, std::placeholders::_1));
	}
	...
	if (pControl)	{
		...
		ASSERT(pMaxBtn);
		pMaxBtn->AttachClick(Bind(&WindowImplBase::OnButtonClick, this, std::placeholders::_1));
	}
	...
	if (pControl)	{
		...
		ASSERT(pRestoreBtn);
		pRestoreBtn->AttachClick(Bind(&WindowImplBase::OnButtonClick, this, std::placeholders::_1));
	}
