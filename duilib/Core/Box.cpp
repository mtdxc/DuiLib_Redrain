...
void ScrollableBox::LoadImageCache(bool bFromTopLeft)
{
	...
	auto forEach = [this, scrollPos](Control* pControl) {
...
void ScrollableBox::LineUp(int deltaValue, bool withAnimation)
{
	...
	if (!withAnimation) {
		...
		m_scrollAnimation.SetCallback(Bind(&ScrollableBox::SetScrollPosY, this, std::placeholders::_1));
...
void ScrollableBox::PlayRenderOffsetYAnimation(int nRenderY)
{
	...
	std::function<void(int)> playCallback = Bind(&ScrollableBox::SetRenderOffsetY, this, std::placeholders::_1);
...
UiRect ScrollableBox::GetScrollBarPadding() const
{
