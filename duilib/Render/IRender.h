...
class UILIB_API IClip : public SupportWeakCallback
{
public:
...
class UILIB_API AutoClip : public SupportWeakCallback
{
public:
...
class UILIB_API IBitmap : public SupportWeakCallback
{
...
class UILIB_API IPen : public SupportWeakCallback
{
public:
...
class UILIB_API IBrush : public SupportWeakCallback
{
public:
...
class UILIB_API IPath : public SupportWeakCallback
{
public:
	IPath(){};
	IPath(const IPath& r){};
...
class UILIB_API IRenderContext : public SupportWeakCallback
{
public:
	virtual HDC GetDC() = 0;
...
{
public:
	virtual IPen* CreatePen(DWORD color, int width = 1) = 0;
	virtual IBrush* CreateBrush(DWORD corlor) = 0;
	virtual IBrush* CreateBrush(HBITMAP bitmap) = 0;
