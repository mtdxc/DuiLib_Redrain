#ifndef UI_UTIL_CALLBACK_H_
#define UI_UTIL_CALLBACK_H_
#pragma once
	...
	->WeakCallback<decltype(std::bind(f, p, args...))>
{
	...
	static_assert(std::is_base_of<SupportWeakCallback, C>::value, "ui::SupportWeakCallback should be base of C");
